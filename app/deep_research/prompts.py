...
def current_time() -> str:
    """返回与 Java PlanExecutePrompts 相同格式的上海当前时间文本。"""
    now = datetime.now(ZoneInfo("Asia/Shanghai"))
    return f"当前正确的系统时间：{now:%Y-%m-%d %H:%M:%S}"


PLAN = """你是【DeepResearch 执行计划规划专家】。
...
CRITIQUE = """你是【DeepResearch 研究评审专家】。
...
REQUIREMENT_CLARIFICATION = """你是【Deep Research 需求分析专家】，只做需求清晰度判断，不直接解答问题。
